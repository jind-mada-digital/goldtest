...
class InsertDirectRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSuccessfulResponse()
    {
        ...
        $this->assertInstanceOf('Ticketpark\SaferpayJson\SecureAliasStore\InsertDirectResponse', $response);
    }
    ...
    public function getResponseMock($successful)
    {
        ...
        if ($successful) {
            $content = $this->getFakedApiResponse('Ticketpark\SaferpayJson\SecureAliasStore\InsertDirectResponse');
        } else {
